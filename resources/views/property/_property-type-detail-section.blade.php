...
<div class="col-md-4 col-sm-6 col-xs-12 heading_space">
    <div class="sim-lar-p">
        ...
        <div class="sim-lar-text">
            <h3 class="bottom10"><a href="news_details.html">{{$types['name']}}</a></h3>
...
<input type="hidden" name="page" id="current-page" value="{{$results['current_page']}}">
<input type="hidden" name="page" id="last-page" value="{{$results['last_page']}}">
@endforeach