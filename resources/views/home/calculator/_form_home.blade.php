    ...
    <div class="row">
        ...
        <div class="form-group">
          <label>KPR Aktif *:</label>    
           <div class="input-group col-md-12">
            {{Form::select('active_kpr',[0=>'Pilih',1=>'1','2'=>'2','3'=>'&gt; 2'],null,['class'=>'form-control'])}}  
           </div> 
        </div>
      </div>
      <div class="col-md-3">
      ...
      <div class="col-md-3">
        <div class="form-group">  
          ...
          <div class="input-group col-md-12">
            <span class="input-group-addon">Rp</span>
            {!! Form::text('down_payment', '', ['class' => 'form-control numericOnly currency','placeholder' => '','id'=>'down_payment','readonly'=>'']) !!}
          </div>
        </div>
      </div>
  </div>
  ...
  <div class="row">
      ...
      <div class="col-md-3">
        <div class="form-group">
          ...
          <div class="input-group col-md-12">
            {{Form::select('interest',[1=>'FLAT',2=>'EFEKTIF','3'=>'EFEKTIF (Fixed - Float)','4'=>'EFEKTIF (Fixed - Floor - Float) '],null,['class'=>'form-control' ,'id'=>'interest_rate_type'])}}
          </div>
        </div>
      </div>
    ...
    <div class="col-md-3">
      <div class="form-group" id="time_period_div">  
        ...
        <div class="input-group col-md-12"> 
           {!! Form::text('time_period', '', ['class' => 'form-control numericOnly ','placeholder' => '0','id'=>'time_period','maxlength'=>'2']) !!}
      ...
      <div class="form-group" id="time_period_total_div">
        ...
        <div class="input-group col-md-12">
         {!! Form::text('time_period_total', '', ['class' => 'form-control numericOnly ','placeholder' => '0','id'=>'time_period_total','maxlength'=>'2']) !!}
          <span class="input-group-addon">Bulan</span>
        </div>
      </div>
    </div>
...
<div class="row">
    ...
    <div class="col-md-3">
      <div class="form-group" id="interest_rate_float_div">
        ...
        <div class="input-group col-md-12">
           {!! Form::text('interest_rate_float', '', ['class' => 'form-control numericOnly ','placeholder' => '0','id'=>'interest_rate_float','maxlength'=>'2']) !!}
          <span class="input-group-addon">% per-tahun</span>
        </div>                                         
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="form-group" id="time_period_floor_div">
        ...
        <div class="input-group col-md-12">
           {!! Form::text('time_period_floor', '', ['class' => 'form-control numericOnly ','placeholder' => '0','id'=>'time_period_floor','maxlength'=>'2']) !!}
          <span class="input-group-addon">Bulan Pertama</span>
        </div>                                   
      </div>
    </div> 
    ...
    <div class="col-md-3">
      <div class="form-group" id="interest_rate_floor_div">
        ...
        <div class="input-group col-md-12">
           {!! Form::text('interest_rate_floor', '', ['class' => 'form-control numericOnly ','placeholder' => '0','id'=>'interest_rate_floor','maxlength'=>'2']) !!}
          <span class="input-group-addon">% per-tahun</span>
        </div>
      </div>
    </div>
