    ...
    @if ($type != 'view')
        <div class="col-md-12">
            <div class="pull-right">
                <a href="{{(session('authenticate.role') == 'developer') ? url('dev/profile') : url('profile/financial')}}" class="btn btn-default waves-light waves-effect w-md m-b-20">Batalkan</a>
